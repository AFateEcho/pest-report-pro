  ...
  async renderToPDF(htmlContent, filename, isPro = false) {
    ...
    if (!isPro) {
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        doc.setFontSize(8);
        const watermark = I18n.currentLang === 'zh'
          ? '由 Pest Report Pro 生成 - 免费版 | 在 fateecho.gumroad.com 解锁专业版'
          : I18n.currentLang === 'es'
            ? 'Generado por Pest Report Pro - Versión Gratuita | Desbloquea Pro en fateecho.gumroad.com'
            : 'Generated by Pest Report Pro - Free Version | Unlock Pro at fateecho.gumroad.com';
        doc.text(watermark, pageWidth / 2, pageHeight - 6, { align: 'center' });
      }
    }
