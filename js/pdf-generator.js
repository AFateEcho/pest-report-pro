    ...
    if (!isPro) {
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        const watermark = I18n.currentLang === 'zh'
          ? '由 Pest Report Pro 生成 - 免费版 | 在 gumroad.com 解锁专业版'
          : I18n.currentLang === 'es'
            ? 'Generado por Pest Report Pro - Versión Gratuita | Desbloquea Pro en gumroad.com'
            : 'Generated by Pest Report Pro - Free Version | Unlock Pro at gumroad.com';
